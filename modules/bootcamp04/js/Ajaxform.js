$("#nikcheck").click(function () {
    ...
    $.ajax({
        type: 'POST',
        url: SITE_URL + "/bootcamp04/nikCheck",
        data: { nik: $("#nik").val() },
...
$('#addKaryawan').click(function () {
    ...
    $.ajax({
        type: 'POST',
        url: SITE_URL + "/bootcamp04/addKaryawan/?id=" + USER_ID,
        data: $('form').serialize(),
        success: function (response) {
            var val = JSON.parse(response);
            alert(val.message);
...
$('#editKaryawan').click(function () {
    ...
    if (selRowId) {
        ...
        $.ajax({
            type: 'POST',
            url: SITE_URL + "/bootcamp04/editKaryawan/" + celValue,
            data: { nik: celValue },
            success: function (response) {
                var val = JSON.parse(response);
                $('#modalBody').empty();
...
$("#saveKaryawan").click(function () {
    ...
    $.ajax({
        type: 'POST',
        url: SITE_URL + "/bootcamp04/saveKaryawan",
        ...
        $("#dialog-confirm").dialog({
            ...
            buttons: {
                ...
                "Delete karyawan": function () {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: SITE_URL + "/bootcamp04/delKaryawan/" + celValue ,
                        data: celValue,
                        success: function (response) {
                            var val = JSON.parse(response);
                            alert(val.message);
