...
grid_selector.jqGrid({
	...
	colModel:[
		...
		{name: 'tanggal_lahir', width: 150, sortable: false, editable: true, editrules: {required: false, date: true}},
		{name: 'umur', width: 150, sortable: false, editable: true, editrules: {required: false, integer: true}},
		{name: 'alamat', width: 150, sortable: false, editable: true, editrules: {required: false}},
		{name: 'telp', width: 150, sortable: false, editable: true, editrules: {required: false, number:true}},
		{name: 'jabatan', width: 150, sortable: false, editable: true, editrules: {required: false}, edittype:'select', editoptions:{value:{1:'Manager',2:'Staff', 3:'Supervisor	'}}},
